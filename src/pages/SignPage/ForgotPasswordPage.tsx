            ...
            <div class="container-app-narrow">
                <div class="bg-white rounded-2xl shadow-xl py-10 px-6 sm:p-12 w-full">
                    ...
                    <div class="text-center mb-10">
                        <h1 class="text-2xl sm:text-5xl font-bold text-color-dark mb-3">Mot de passe oublié ?</h1>
                        <p class="text-gray-500 text-base sm:text-lg">Pas de panique, on va t'aider à le récupérer</p>
                    </div>
