        ...
        <div class="w-full max-w-2xl mx-auto">
            <div class="flex items-center justify-between mb-8">
                <div class="flex items-center gap-3">
                    <Calendar size={32} class="text-color-main" />
                    <h3 class="text-2xl font-bold text-color-dark">Dates et durée</h3>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            readonly
                            class="input input-bordered w-full bg-white text-color-dark text-lg cursor-pointer"
                        />
                    </div>
                ...
                {calculateDuration() && (
                    <div class="bg-color-light rounded-xl p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                <h4 class="text-color-dark font-semibold text-lg mb-1">Durée calculée</h4>
                                <p class="text-sm text-gray-600">
                                    Basée sur vos dates sélectionnées
                                </p>
                            </div>
                            <div class="text-right">
                                <div class="text-4xl font-bold text-color-main">{calculateDuration()}</div>
                                <div class="text-sm text-gray-600">jours</div>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 gap-4 mt-4 pt-4 border-t border-gray-200">
                            <div class="text-center">
                                <div class="text-2xl font-bold text-color-secondary">{props.minDays}</div>
                                <div class="text-xs text-gray-600">Minimum</div>
                            </div>
                            <div class="text-center">
                                <div class="text-2xl font-bold text-color-secondary">{props.maxDays}</div>
