        ...
        <div class="flex flex-col gap-4">
            ...
            <Show when={props.isUserTrip && !props.isEditing}>
                ...
                <A href={"/conversations"}
                    class="w-full border-2 border-gray-300 text-color-dark py-3 rounded-xl font-semibold hover:bg-color-light hover:border-[#146865] transition-all duration-200 flex items-center justify-center gap-2 hover:scale-105 hover:shadow-md active:scale-95 mb-3">
                    <MessageCircle size={20} />
                    Voir les questions
                </A>
                <button
                    onClick={props.onDelete}
                    class="w-full border-2 border-red-500 text-red-600 py-3 rounded-xl font-semibold hover:bg-red-50 transition-all duration-200 flex items-center justify-center gap-2"
                >
                    <X size={20} />
                    Supprimer le voyage
                </button>
